...
<div class="container">
	...
	<form action="write.do" method="post" enctype="multipart/form-data">
		<div >
			...
			<div class="form-inline form-group">
				<label for="sale_startDate" class="mr-2"><b>> 판매 시작일</b></label>
				<input class="form-control mr-5 datepicker" id="sale_startDate" name="sale_startDate" placeholder="시작일" required readonly>
				 ~ 
				 <label for="sale_endDate" class="mr-2 ml-5"><b>> 판매 종료일</b></label>
				<input class="form-control mr-2 datepicker" id="sale_endDate" name="sale_endDate" placeholder="종료일" required readonly>
			</div>
			<!-- 가격정보 입력 끝 -->
