...
$(function() {
	...
	$(".flightList").load("/ajax/getFlightList.do?airlineNo=1");
	...
	$(".addBtn").click(function(){
	    ...
	    newRow.find(".flightList").load("/ajax/getFlightList.do?airlineNo=1");
		return inputRowCnt++;
	});
				...
				<div>
					...
					<table class="table text-center">
						<tr>
							...
							<th style="width:15%;background-color:#ff782b;">출발일</th>
							<th style="width:15%;background-color:#ff782b;">출발시간</th>
							<th style="width:15%;background-color:#db3d08;">도착일</th>
							<th style="width:15%;background-color:#db3d08;">도착시간</th>
